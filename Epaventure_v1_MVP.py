...
#Classe pour manipuler le jeu
    ...
    def start(self):
        ...
        print("Vous avez pénétré dans le couloir attenant au sas. Sur votre droite, il vous semble percevoir un mouvment dans l'obscurité, plus loin dans le couloir. A gauche, une porte fermée donne sur le couloir, qui continue plus loin dans l'obscurité.")
    ...
    def crochetage_porte(self):
        ...
        print("\nLe mécanisme de la porte de sécurité est bloqué en position fermée. Tu démontes le panneau de la commande et tente de réactiver son fonctionnement.\n")
    ...
    def explorer_couloir(self):
        ...
        deuxd6 = random.randint(1,6)
        jet = und6 + deuxd6
        print("Tu obtiens un", jet, "en combat.")
        if jet >= 10:
            print("Tu parviens à tuer cette créature avec ton cutter à plasma. A ts pieds se trouve le corps de la créature et un corps, sans doute sa victime. Le corps en combinaison agrippe toujours un fusil énergétique que tu récupères.")
        elif jet < 10 and jet >=7:
