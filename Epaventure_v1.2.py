...
#Classe pour manipuler le jeu
    ...
    def crochetage_porte(self):
        ...
        #jet = self.lancer_des(2, 6, self.fute)
        jet, resultat = self.lancer_des(modificateur=self.fute)
    ...
    def explorer_couloir(self):
        ...
        jet, resultat = self.lancer_des(modificateur=self.coriace)
...
print("=====================================================")
print("Un jeu codé en Python par Grégoire Macqueron (2026), sous double licence GNU GPL v3 et Creative Commons CC BY-SA 4.0.")
quit()