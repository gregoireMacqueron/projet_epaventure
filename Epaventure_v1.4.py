...
#==================
    ...
    def __init__(self):
        ...
        print("Votre réserve d'air est de", air, "%.")
        print("\n====================================")
    ...
    def start(self):
        ...
        while True:
            ...
            self.air = self.air-1
            print("Ta réserve d'air est de", self.air, "%.")
            ...
            if "conso" in scene and resultat in scene["conso"]:
                conso = scene["conso"][resultat]
                self.air -= conso
                print("La situation te coûte", conso, "% d'air.")
                print("Réserve restante :", self.air, "%")
